...
$val = $db->multipleColumn("SELECT * FROM `files` WHERE  `presence` = ?", array(1));
...
?>
<form method="post" action="inc/download.php" id="fileDownload">
                <input type="hidden" name="file_loc" id="file_loc" value=""/>
                <input type="hidden" name="poll" id="poll" value=""/>
            </form>
            <form method="post" action="inc/decrypt.php" id="fileDownloadEncrypt">
                <input type="hidden" name="file_loc" id="file_loc" value=""/>
                <input type="hidden" name="poll" id="poll" value=""/>
            </form>
...
<input type="hidden" name="page" value="all_resource" id="pageName">
    
        <h3><i class="fa fa-folder-open"> </i> All Files on Cloud</h3>
        <hr class="divider">
