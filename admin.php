                        ...
                        <div class="modal-body">
                            <form class="form-horizontal" role="form" id="uploadForm" action="inc/upload.php" method="POST" enctype="multipart/form-data">
                                    <div class="form-group">                                      
                                        <div class="col-sm-12">
                                            <input type="text" class="form-control" id="key" name="prikey" placeholder="Enter Private Key">
                                        </div>
                                    </div>
                                    <div class="form-group">                                      
                                        <div class="col-sm-12">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form class="form-horizontal" role="form" id="decryptForm" action="" method="POST">
                                    <div class="form-group">                                      
                                        <div class="col-sm-12">
                                            <input type="text" class="form-control" id="decryptKey" name="prikey" placeholder="Enter Private Key">
                                        </div>
                                    </div>
                                    <div class="form-group">                                      
                                        <div class="col-sm-12">
